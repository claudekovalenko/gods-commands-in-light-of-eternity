...
const UI = {
  en: {
    ...
    views: { map: 'Map', list: 'List', review: 'Review' },
    search: 'Search themes and verses…',
    ...
    shuffle: 'Shuffle',
    ofCount: 'of',
    reviewHint: 'Recall what Scripture says, then reveal. Space reveals · arrows move.',
    verseCount: 'verses',
  ...
  ar: {
    ...
    views: { map: 'الخريطة', list: 'القائمة', review: 'المراجعة' },
    search: 'ابحث في المواضيع والآيات…',
    resetView: 'إعادة الضبط',
    noMatches: 'لا توجد نتائج مطابقة.',
    allGroups: 'كل المجموعات',
    showVerses: 'أظهر الآيات',
    next: 'التالي',
    prev: 'السابق',
    shuffle: 'ترتيب عشوائي',
    ofCount: 'من',
    reviewHint: 'تذكَّر ما يقوله الكتاب المقدس ثم اكشف. المسافة تكشف · الأسهم تتنقل.',
    verseCount: 'آيات',
